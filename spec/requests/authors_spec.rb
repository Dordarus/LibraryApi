...
RSpec.describe 'Authors', type: :request do
  ...
  describe 'POST /authors' do
    # valid payload
    let(:valid_attributes) { { author: { first_name: 'Freddie', last_name: 'Mercury', bio: 'Some bio'} }}
    ...
    context 'when the request is invalid' do
      before { post '/authors', params: { author:{first_name: 'Freddie', last_name: 'Mercury'}}}
  ...
  describe 'PATCH /authors/:id' do
    let(:valid_attributes) {{ author:{ first_name: 'Roger', last_name: 'Taylor'} }}

    context 'when the record exists' do
      before { patch "/authors/#{author_id}", params: valid_attributes }
